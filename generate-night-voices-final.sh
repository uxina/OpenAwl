...
# 参考长期记忆中的语音生成规范
# 格式: MP3, 采样率: 48000 Hz, 声道: Mono, 比特率: 65 kb/s, 编码: libmp3lame
TARGET_SAMPLE_RATE = 48000
TARGET_CHANNELS = 1
TARGET_BITRATE = "65k"  # 使用长期记忆中的标准比特率

def save_mp3(wav_path, mp3_path, sample_rate=48000, bitrate="65k"):
    """转换为 MP3，使用长期记忆中的标准参数"""
    cmd = [
        "ffmpeg", "-y",
        "-i", wav_path,
        "-ar", str(sample_rate),
...
print(f"  声道: Mono (单声道)")
print(f"  比特率: {TARGET_BITRATE} (标准规范)")
print(f"  编码: libmp3lame")
print()
print("TTS 参数:")
